        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ $isAdmin ? route('admin.dashboard') : route('office.dashboard') }}">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(!$isAdmin)
                        <x-nav-link
                            ...
                            :active="request()->routeIs('office.dashboard')">
                            Dashboard
                        </x-nav-link>

                        <x-nav-link
                            :href="route('office.documents.index')"
                            :active="request()->routeIs('office.documents.*')">
                            Documents
                        </x-nav-link>
                    @endif
